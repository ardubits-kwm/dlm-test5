...
//APDS9960-------------------------------------------------------
	...
	*/
    function readWord2C(reg: REGISTER): number {
        let val4 = readWord(MPU6050_I2C_ADDRESS.ADDR_0x68, reg)
        if (val4 > 0x8000) {
            return -((65535 - val4) + 1)
        } else {
            return val4
	...
	*/
    ...
    export function getAngle(axis: AXIS): number {
        switch (axis) {
            case AXIS.X:
                return Math.acos(getAccel(MPU6050_I2C_ADDRESS.ADDR_0x68, axis)) * 57.29577
            case AXIS.Y:
                return Math.acos(getAccel(MPU6050_I2C_ADDRESS.ADDR_0x68, axis)) * 57.29577
            case AXIS.Z:
                return Math.acos(getAccel(MPU6050_I2C_ADDRESS.ADDR_0x68, axis)) * 57.29577
	...
	*/
    ...
    export function getAccel(axis: AXIS): number {
        switch (axis) {
            case AXIS.X:
                return (readWord2C(MPU6050_I2C_ADDRESS.ADDR_0x68, REGISTER.ACCEL_X) + X_ACCEL_OFFSET) / 16384.0
            case AXIS.Y:
                return (readWord2C(MPU6050_I2C_ADDRESS.ADDR_0x68, REGISTER.ACCEL_Y) + Y_ACCEL_OFFSET) / 16384.0
            case AXIS.Z:
                return (readWord2C(MPU6050_I2C_ADDRESS.ADDR_0x68, REGISTER.ACCEL_Z) + Z_ACCEL_OFFSET) / 16384.0
            default:
                return 0
        }
        return 0
	...
	*/
    ...
    export function getGyro(axis: AXIS): number {
        ...
        switch (axis) {
            case AXIS.X:
                return (readWord2C(MPU6050_I2C_ADDRESS.ADDR_0x68, REGISTER.GYRO_X) + X_GYRO_OFFSET)
            case AXIS.Y:
                return (readWord2C(MPU6050_I2C_ADDRESS.ADDR_0x68, REGISTER.GYRO_Y) + Y_GYRO_OFFSET)
            case AXIS.Z:
                return (readWord2C(MPU6050_I2C_ADDRESS.ADDR_0x68, REGISTER.GYRO_Z) + Z_GYRO_OFFSET)
            default:
                return 0
        }
        return 0
